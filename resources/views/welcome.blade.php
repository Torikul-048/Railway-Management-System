...
<div class="relative py-20 overflow-hidden">
    ...
    <div class="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-5 justify-center items-center">
            <a href="{{ route('register') }}" class="group inline-flex items-center justify-center px-10 py-5 text-base font-bold rounded-xl text-primary-700 bg-white hover:bg-primary-50 shadow-2xl hover:shadow-white/50 transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
            ...
            <a href="{{ route('login') }}" class="group inline-flex items-center justify-center px-10 py-5 border-2 border-white/80 text-base font-bold rounded-xl text-white bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
