...
<div class="mb-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Edit Train Schedule</h1>
            <p class="mt-2 text-sm text-gray-600">Update train route and schedule details</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="time" 
                       name="departure_time" 
                       id="departure_time" 
                       value="{{ old('departure_time', $train->departure_time ? $train->departure_time->format('H:i') : '') }}"
                       required
            ...
            <div>
                ...
                <input type="time" 
                       name="arrival_time" 
                       id="arrival_time" 
                       value="{{ old('arrival_time', $train->arrival_time ? $train->arrival_time->format('H:i') : '') }}"
                       required
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" 
                          ...
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent @error('description') border-red-500 @enderror">{{ old('description', $train->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
