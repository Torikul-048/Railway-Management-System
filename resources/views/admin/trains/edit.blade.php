...
@section('title', 'Edit Train - Railway Management System')
...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center py-3">
        <div>
            <h1 class="h3 mb-0 text-gray-800">Edit Train Schedule</h1>
            <p class="text-muted">Update train details for {{ $train->train_number }} - {{ $train->name }}</p>
        </div>
        <div>
            <a href="{{ route('admin.trains.show', $train) }}" class="btn btn-secondary">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Update Train Schedule Details</h6>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.trains.update', $train) }}">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                    ...
                                    <option value="mail" {{ old('type', $train->type) == 'mail' ? 'selected' : '' }}>Mail</option>
                                    <option value="passenger" {{ old('type', $train->type) == 'passenger' ? 'selected' : '' }}>Passenger</option>
                                    <option value="intercity" {{ old('type', $train->type) == 'intercity' ? 'selected' : '' }}>Intercity</option>
                                </select>
                                @error('type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" 
                                       ...
                                       id="source_station" 
                                       name="source_station" 
                                       value="{{ old('source_station', $train->source_station) }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('destination_station', $train->destination_station) }}" 
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="time" 
                                       ...
                                       id="departure_time" 
                                       name="departure_time" 
                                       value="{{ old('departure_time', $train->departure_time->format('H:i')) }}" 
                                       required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="time" 
                                       ...
                                       id="arrival_time" 
                                       name="arrival_time" 
                                       value="{{ old('arrival_time', $train->arrival_time->format('H:i')) }}" 
                                       required>
                                @error('arrival_time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="form-text text-warning">
                                    ...
                                    Changing total seats may affect existing bookings
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="number" 
                                       ...
                                       id="fare_per_seat" 
                                       name="fare_per_seat" 
                                       value="{{ old('fare_per_seat', $train->fare_per_seat) }}" 
                                       min="1" 
                                       step="0.01" 
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" 
                                       ...
                                       id="facilities" 
                                       name="facilities" 
                                       value="{{ old('facilities', $train->facilities) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="Additional information about the train...">{{ old('description', $train->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('admin.trains.show', $train) }}" class="btn btn-secondary me-md-2">
                                <i class="fas fa-times me-2"></i>Cancel
                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Update Train Schedule
                            </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <strong>Train:</strong> {{ $train->train_number }} - {{ $train->name }}
                    </div>
                    <div class="mb-3">
                        <strong>Current Status:</strong>
                        <span class="badge bg-{{ $train->status == 'active' ? 'success' : ($train->status == 'maintenance' ? 'warning' : 'secondary') }}">
                            {{ ucfirst($train->status) }}
                        </span>
                    </div>
                    <div class="mb-3">
                        <strong>Current Route:</strong> {{ $train->source_station }} → {{ $train->destination_station }}
                    </div>
                    <div class="mb-3">
                        <strong>Current Timing:</strong> {{ $train->departure_time->format('H:i') }} - {{ $train->arrival_time->format('H:i') }}
                    </div>
                    <div class="mb-3">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <li class="mb-2">
                            ...
                            <strong>Bookings:</strong> This train has {{ $train->bookings()->count() }} existing bookings
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-clock text-warning me-2"></i>
                            <strong>Timing Changes:</strong> May affect passengers' travel plans
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-users text-danger me-2"></i>
                            <strong>Seat Changes:</strong> Reducing seats may invalidate bookings
                        </li>
                        <li class="mb-0">
                            <i class="fas fa-money-bill text-success me-2"></i>
                            <strong>Fare Changes:</strong> Only affect new bookings
                        </li>
                    </ul>
                </div>
            </div>
